...
1. Use ':bn' 20 times to move between files, buffers, or windows.
...
2. Include at least 5 transitions that rely on ':bn'.
3. If you get lost, recover using list/status commands only.

## Mastery Drill (6 min)
1. Time a complete multi-file edit run anchored on ':bn'.
