# Daily Exercises for :bn

## Practice Buffers
Create three files: `work/a.txt`, `work/b.txt`, `work/c.txt` with lines `EX-01`..`EX-10`.

## Exercise List
1. Open all three files and use `:bn` as your primary navigation/switch command.
...
9. Close or isolate views using `:bn` flow where applicable.
