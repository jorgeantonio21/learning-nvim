...
1. Run 'o' 30 times on different cursor positions.
...
1. Edit a paragraph so every sentence gains one extra qualifier using 'o'.
2. Use counts where valid (for example `3o`) and compare results.
