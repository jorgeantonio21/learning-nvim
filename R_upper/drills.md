...
1. Run 'R' 30 times on different cursor positions.
...
1. Edit a paragraph so every sentence gains one extra qualifier using 'R'.
2. Use counts where valid (for example `3R`) and compare results.
