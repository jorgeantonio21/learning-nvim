# Daily Exercises for gt

## Practice Buffers
Create three files: `work/a.txt`, `work/b.txt`, `work/c.txt` with lines `EX-01`..`EX-10`.

## Exercise List
1. Open all three files and use `gt` as your primary navigation/switch command.
...
9. Close or isolate views using `gt` flow where applicable.
